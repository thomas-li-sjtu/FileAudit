<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Userid" align="center" width="75px">
        <template slot-scope="{row}">
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getList("fchownat", this.listQuery).then(response => {
    ...
    handleDelete(row, index) {
      ...
      deleteRecord("fchownat_delete", this.deleteQuery).then(response => {
